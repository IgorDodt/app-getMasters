...
export const Routes = [
    ...
    { method: "get", route: "/requestAnswer/:orderUid/all", controller: RequestOrderAnswersController, action: "all" },
    { method: "post", route: "/requestAnswer", controller: RequestOrderAnswersController, action: "save" },
    { method: "delete", route: "/requestAnswer/:id", controller: RequestOrderAnswersController, action: "remove" },
];